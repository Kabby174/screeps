...
const sortRooms = () => {
	...
	// 	groupName: roomName+"_"+exitName+"_1"
	// };
	// MemoryLists.add(Object.assign({}, roomKey, {
	// 	squad: Squad.createParty({
	// 		type: Squad.TYPES.REMOTE_WORKERS,
	// 		props: {
	// 			roomName,
	// 			worksite: exitName,
	...
	for(let roomName in Game.rooms){
		...
		if(//!roomMemory.EXITS &&
			...
			for(let direction in exitArray){
				...
				if(getRoom(exitName).MODE == "OUTPOST"
					...
					// console.log("Create Party", Object.keys(Squad.createParty({
					// 	type: Squad.TYPES.REMOTE_WORKERS,
					// 	props: {
					// 		roomName,
					// 		worksite: exitName,
				...
				// console.log("Add outpost", roomName, exitName);
			}
